...
class ViewAllStudents extends StatefulWidget {
  var dep;
  ViewAllStudents({super.key,this.dep});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: AppText(data:"View Students",color: Colors.white,size: 16,),
        ),
        body: SafeArea(
          child: Container(padding: EdgeInsets.all(20),
              child: StreamBuilder(
                stream: FirebaseFirestore.instance.collection('student').where('department',isEqualTo: widget.dep).snapshots(),
                builder: (context, snapshot) {
                  ...
                  if(snapshot.hasData &&  snapshot.data!.docs.length==0) {
                    ...
                    return NoDataWidget(errorMessage: "No Students Added");
                  }
