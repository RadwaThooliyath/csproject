...
class ViewTeacherUser extends StatefulWidget {
  var dep;
  ViewTeacherUser({super.key,this.dep});

  @override
  State<ViewTeacherUser> createState() => _ViewTeacherUserState();
}

class _ViewTeacherUserState extends State<ViewTeacherUser> {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: Container(padding: EdgeInsets.all(20),
              child: StreamBuilder(
                stream: FirebaseFirestore.instance.collection('teacher').where('department',isEqualTo: "Commerce").snapshots(),
