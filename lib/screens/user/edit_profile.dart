  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  AppText(data:"Edit Profile",size: 16,color: Colors.white,),
      ),
      body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                CustomTextFormField(controller: _addressController, hintText: "Enter  Semester (SEM 1)",validator: (value){
                  if(value!.isEmpty){
                    return "Enter  Semester (SEM 1)";
                  }
                },style: TextStyle(color: Colors.white)),
                SizedBox(height: 20,),
