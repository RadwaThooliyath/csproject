...
class ViewEventsTchr extends StatefulWidget {
  const ViewEventsTchr({super.key});

  @override
  State<ViewEventsTchr> createState() => _ViewEventsTchrState();
}

class _ViewEventsTchrState extends State<ViewEventsTchr> {
  String? _type;
  String? uid;
  String? name;
  String? email;
